...
use Krajcik\DataBuilder\Reflection\DoctrineEntity;

final class BuilderToGenerateDto
{
    /**
     * @param array<string, string> $columnToPropertyNames
     */
    private function __construct(private string $tableName, private string $fullClassName, private ?array $columnToPropertyNames = null)
    {}
